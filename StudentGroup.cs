...

{
    public class StudentGroup
    {
        ...
        public void RemoveStudent(string recordBookNumber) =>
            _members.RemoveAll(m => m is Student s && s.RecordBookNumber
== recordBookNumber);
        ...
        {
            StringBuilder csv = new StringBuilder(); csv.AppendLine("Type,FullName,RecordBookNumber,AverageGrade,Scholarship,Details");
